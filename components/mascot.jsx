...
export function MascotSVG({ mood }) {
  const eyes =
    mood === "sleepy" ? (
      <>
        <path d="M23 30 q4 -4 8 0" stroke="var(--foreground)" strokeWidth="2.4" fill="none" strokeLinecap="round" />
        <path d="M37 30 q4 -4 8 0" stroke="var(--foreground)" strokeWidth="2.4" fill="none" strokeLinecap="round" />
      </>
    ) : (
      <>
        <circle cx="27" cy="30" r="4.2" fill="var(--foreground)" />
        <circle cx="41" cy="30" r="4.2" fill="var(--foreground)" />
  ...
  const mouth =
    mood === "sleepy" ? (
      <line x1="30" y1="41" x2="38" y2="41" stroke="var(--foreground)" strokeWidth="2.2" strokeLinecap="round" />
    ) : mood === "hype" ? (
      <>
        <ellipse cx="34" cy="42" rx="6" ry="5" fill="var(--foreground)" />
        <ellipse cx="34" cy="40" rx="5" ry="2.4" fill="#fff" />
      </>
    ) : (
      <path d="M27 39 q7 8 14 0" stroke="var(--foreground)" strokeWidth="2.4" fill="none" strokeLinecap="round" />
    );
  const extras =
    mood === "sleepy" ? (
      <>
  ...
  return (
    <svg viewBox="0 0 64 64" className="mascot-svg">
      ...
      <path d="M20 20 l-8 -10" stroke="var(--warn)" strokeWidth="3" strokeLinecap="round" />
      <circle cx="11" cy="9" r="3" fill="var(--good)" />
      <path d="M17 46 q-8 3 -11 10" stroke="var(--foreground)" strokeWidth="2.6" fill="none" strokeLinecap="round" />
      <path d="M51 46 q8 3 11 10" stroke="var(--foreground)" strokeWidth="2.6" fill="none" strokeLinecap="round" />
      {eyes}
      {mouth}
      {extras}
    </svg>
